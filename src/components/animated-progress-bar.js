// Code taken from React native progress bar but with added 'useNativeDriver: false': https://github.com/rafaelmotta/react-native-progress-bar-animated/blob/master/src/AnimatedProgressBar.js
...
class ProgressBar extends React.Component {
  ...
  animateWidth() {
    ...
    Animated.timing(this.widthAnimation, {
      ...
      useNativeDriver: false, // Added new parameter
    }).start();
  }
